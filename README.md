...
For the automation suite I decided to use pytest because is simple to share a fixture like driver without develope that logic for handle the driver across all test
